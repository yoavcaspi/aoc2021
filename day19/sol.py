...
def sol(data: str) -> int:
    ...
    for val in data.split("\n\n"):
        ...
        scanners.append([tuple([int(v) for v in va.split(",")]) for va in val.splitlines()[1:]])
    print(scanners[0])
        ...
        for solved_beacon in deepcopy(solved_beacons):
            for i in range(24):
                ...
                for val1 in s_direction:
                    ...
                    new_s = set([(v1[0]-diff_x, v1[1]-diff_y, v1[2]-diff_z) for v1 in s_direction])
    ...
    for b in sorted(list(solved_beacons)):
        print(b)
    return len(solved_beacons)
